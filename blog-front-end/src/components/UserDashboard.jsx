...
const UserDashboard = ({ updateArticleToEdit, updateCategoryToEdit }) => {
  ...
  useEffect(() => {
    fetch("https://blog-api-production-f2ce.up.railway.app/blog/articles_user", {
      method: "GET",
      headers: headers,
    })
      .then((response) => {
  ...
  useEffect(() => {
    fetch("https://blog-api-production-f2ce.up.railway.app/blog/category_list", {
      headers: headers,
    })
      .then((response) => response.json())
      .then((data) => {
  ...
  const deleteCategory = async () => {
    ...
    const response = await fetch(
      "https://blog-api-production-f2ce.up.railway.app/blog/category_delete",
      {
        method: "POST",
  ...
  const deletePost = async () => {
    ...
    const response = await fetch(
      "https://blog-api-production-f2ce.up.railway.app/blog/article_delete",
      {
        method: "POST",
  ...
  const deleteAccount = async () => {
    const response = await fetch(
      "https://blog-api-production-f2ce.up.railway.app/blog/account_delete",
      {
        method: "GET",
        headers: headers,
      }
